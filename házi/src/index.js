...
const library = new libary_1.Library();
// Kategóriák létrehozása
const fictionCategory = new category_1.Fiction("Fiction", "Novel");
const nonFictionCategory = new category_1.NonFiction("Non-Fiction", "History");
...
const borrower1 = { id: 1, name: "John Doe" };
const borrower2 = { id: 2, name: "Jane Doe" };
